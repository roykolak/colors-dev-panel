...
(function() {
  var BlendView, ColorModel, ColorView, ColorsView, RangeView, SchemaView, TabView,
  ...
  SchemaView = (function(_super) {
    ...
    SchemaView.prototype.renderColors = function() {
      ...
      view = new ColorsView({
        colors: ColorLib.sixToneCW(color)
      });
      return this.$('.sixToneCW').html(view.render().el);
    };
